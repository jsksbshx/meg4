...
bot = telebot.TeleBot('7672697055:AAFyZimqACXlyuUIwI35NZtcgNEHnP716sc')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @SAYYED_Z."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @SAYYED_Z ."
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = "BhenChod Manega Nhi tu."
    bot.reply_to(message, response)
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        if attack_running:
            response = "An Attack Is Already Running.\nUse This Command Later."
            bot.reply_to(message, response)
            return
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 160:
                response = "Bhai itna lamba na lagao,dusro ko bhi mauka do"
            else:
...
Buy From :- @SAYYED_Z
Official Free Group :- https://t.me/+dh0d4DG6h7tlZGU1
'''
...
def welcome_start(message):
    ...
    response = f'''🔥 WELCOME TO FREE DDOS SERVICE , {user_name}! Sabse acche se bgmi ki maa behen yahi hack karta hai. Kharidne ke liye Kira se sampark karein.
🤗Try To Run This Command : /help 
     For Free Ddos :- https://t.me/+dh0d4DG6h7tlZGU1
💵BUY :-@SAYYED_Z'''
    bot.reply_to(message, response)
...
3. MAKE SURE YOU JOINED https://t.me/+dh0d4DG6h7tlZGU1 OTHERWISE NOT WORK
